            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className='flex items-center justify-center gap-2 w-full py-2 mt-4 text-lg font-medium text-white bg-amber-500 rounded-md hover:bg-amber-600 transition duration-300 cursor-pointer'
                >
